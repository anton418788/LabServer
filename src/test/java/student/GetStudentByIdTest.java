...
public class GetStudentByIdTest {
    ...
    void getStudentByIdTest() throws Exception {
        ...
        assertEquals(writer10.toString(), "200::{\"groupId\":1,\"surname\":\"Igorev\",\"name\":\"Artem\",\"patronymic\":\"Patronymic\",\"status\":\"study\"}");
        assertEquals(writer20.toString(), "200::{\"groupId\":3,\"surname\":\"Ermolaev\",\"name\":\"Igor\",\"patronymic\":\"Patronymic\",\"status\":\"vacation\"}");
        assertEquals(writer30.toString(), "200::{\"groupId\":2,\"surname\":\"Petrova\",\"name\":\"Yulia\",\"patronymic\":\"Patronymic\",\"status\":\"expelled\"}");
    }
